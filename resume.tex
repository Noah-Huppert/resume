...
\section{Work Experience}
	...
	\begin{itemize}
		\item Constructed a tool which automatically verified the integrity of daily database backups by provisioning
			AWS resources and restoring the backup to a test database instance, ensuring that the company's business
			data was recoverable in the event of a primary database failure
