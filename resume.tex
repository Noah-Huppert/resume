...
% Skills
\section{Skills}
    \textbf{Programming Languages:} Typescript, SQL, JavaScript, Python, HTML, CSS, Java, Go, Rust, C++, C\#, Bash \\ % Ruby, PHP
...
\section{Work Experience}
    % Mainstay
    % architecting, prototyping, proposing
	\textbf{Mainstay} \hfill Cambridge, MA \\
	\textit{Fullstack Software Engineer} \hfill June 2021 - Current \\
    \begin{itemize}
        \item Architecting cloud native micro-services for a scholarship search tool, simplifying the scholarship search process for students and allowing them to access more affordable higher education

		\item Prototyping event based cloud native solutions to increase the scale of users which the platform can message and enabling customers to communicate with more students with higher reliability

        \item Proposing and implementing remote development workspaces, allowing easy access to a pre-setup Docker stack, enabling development on consistent environments and new employees to onboard in under a day 
	\end{itemize}
