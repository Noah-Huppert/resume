...
\section{Work Experience}
	...
	\begin{itemize}
			% construct, evaluate, architect, design, develop, engineer, produce, implement, wrote
		...
		\item Integrating a service mesh into Kubernetes to increase observability and make deployments more reliable
			via canary roll out techniques
		\item Building a system to run machine learning models on demand with Kubernetes in response to events by using 
			serverless design patterns - enabling clients to stop worrying about infrastructure and focus on writing
			models
	\end{itemize}
...
\section{Project Experience}
	\begin{itemize}
		...
		\item GH Gantt - Create a Gantt chart based off of GitHub issues - Sponsored open source project
