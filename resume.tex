...
% Education
\section{Education}
	Drexel University \hfill Philadephia, PA \\
...
\section{Skills}
	...
	\textbf{Programming} & \\
	\textbf{Languages:} & C++, C\#, Java, Python, Javascript, Go, Rust, Swift, Ruby, HTML, CSS, SQL, PHP, Bash, LaTeX \\
	\end{tabularx}
...
\section{Work Experience}
	...
	\begin{itemize}
		...
		\item Develop backend SMS chat bot logic which thousands of customers use
...
\section{Activities}
	...
	Mentor, First Lego League, 2015 \hfill Volunttaeer, Metrowest Medical Clinic, 2009 - 2017
